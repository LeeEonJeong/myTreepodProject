						...
						<div  id='volumeactiondiv'> 
							<table id="volumeaction_table" class="table table-condensed" >
							 	<tr>
							 		<th class="subtitle">기능</th>
							 		<th>
							 			<input class = 'btn' id='connectcipbtn' type='button' value='CIP 연결' data-toggle='modal' data-taget='#connectCPIModal'/>
							 			<input class = 'btn' id='disconnectcipbtn' type='button' value='CIP 연결 해지' data-toggle='modal' data-taget='#disconnectCPIModal'/>
							 		</th> 
							 	</tr> 
							</table>
						</div>
